...
\begin{figure}[!ht]121cr
	\centering
	\includegraphics{calculus/wall}
	\caption{Outro paradoxo de Zeno: o homem nunca alcança a parede.}
\end{figure}
...
s_6 &= \frac{1}{2}+\frac{1}{4}+\frac{1}{8}+\frac{1}{16}+\frac{1}{32}+\frac{1}{64}=0.984375\\\vdots\\
s_{16} &= \frac{1}{2}+\frac{1}{4}+\dots+\frac{1}{2^{16}}\sim 0,99998474
\end{aligned}$$
A soma parcial se torna próxima de 1. Aumentando $n$, $s_n$ se torna mais próximo de 1. Torna-se razoável definir a soma da série infinita como 1: $$\frac{1}{2}+\frac{1}{4}+\dots+\frac{1}{2^n} = 1$$. A razão por ser 1 é: $\lim_{n\rightarrow\infty}s_n=1$ 
\subsection{Sumário}
a
